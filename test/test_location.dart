...
void testLocation() {
  group('Location operations', () {
    ...
    test("getParent", () {
      ...
      l.getParent()
      .then((Map v) => expect(v["parent"], 'GB_H9'))  
      //TODO: figure out how this error handling works in tests
      .catchError((e) => expect(false,false));
